...
export default function TextForm(props) {
  ...
  const handleCamelCaseClick = (str) => {
    ...
    setText(camelCase);
    text.length > 0
      ? props.showAlert("Text has been converted to camelCase", "success")
      : props.showAlert("Please enter some text", "error");
  };
  ...
  const handleInverseCaseClick = () => {
    ...
    setText(inverseCase);
    text.length > 0
      ? props.showAlert("Text has been converted to InverseCase", "success")
      : props.showAlert("Please enter some text", "error");
  };

  return (
    <div
      className={`m-5 ${props.mode === "dark" ? "bg-gray-800 text-white" : ""}`}
    >
      <div>
        <div className="flex flex-col gap-3">
          <label
            ...
            className={`text-3xl p-5 ${
              props.mode === "dark" ? "bg-gray-800" : "bg-gray-400 "
            }`}
          >
            {props.label}
          </label>
          <textarea
            ...
            id="myBox"
            className={`p-5 ${
              props.mode === "dark" ? "bg-gray-500 text-white" : ""
            }`}
            rows={5}
      ...
      <div className="mt-5">
        ...
        <p className="overflow-auto h-36 border border-black p-5 rounded-xl mt-3">
